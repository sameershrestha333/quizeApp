...
class Quiz {
	...
	void begin() {
		...
		Question q4 = new Question("for what purpose is the this() constructor is used?",
				...
				"none of above", new Answer("to invoke the parent class constructor"));
		...
		Question q5 = new Question("when does the object becomes unreachable ?",
				...
				"none of above", "first two", new Answer("first two"));
		...
		for (Question q : questionArray) {
			...
			switch (option) {
			case 'A':
				answer = q1.getOption1();
				break;
			case 'B':
				answer = q2.getOption2();
				break;
			case 'C':
				answer = q3.getOption3();
				break;
			case 'D':
				answer = q4.getOption4();
				break;
			default:
				break;
